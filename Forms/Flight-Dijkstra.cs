...
{
    public partial class Flight_Dijkstra : Form
    {
        List<Point> nodes = new List<Point>();
        List<Edge> edges = new List<Edge>();
        Random rand = new Random();
        public Flight_Dijkstra()
        {
            InitializeComponent();
        }
        ...
        {
            GenerateRandomPoints(100); // random 10 điểm
        }

        private void Flight_Dijkstra_Load(object sender, EventArgs e)
        {
            nodes.Clear();
            edges.Clear();
